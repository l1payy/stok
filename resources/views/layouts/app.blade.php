        ...
        <div class="min-h-screen flex flex-col md:flex-row">
            ...
            <aside class="hidden md:flex flex-col w-[240px] bg-primary text-white min-h-screen fixed left-0 top-0 bottom-0 z-20">
                <div class="p-6 flex flex-col items-center">
                    ...
                    <h1 class="text-sm font-bold leading-tight text-center uppercase">Website Monitoring<br>Stok Obat</h1>
                    <p class="text-[10px] text-blue-200 opacity-80 text-center mt-1 uppercase">UPT Puskesmas Karang Rejo</p>
                </div>
                ...
                <div class="p-4 mt-auto">
                    <a href="{{ route('password.change') }}" class="w-full flex items-center px-4 py-2 text-sm text-blue-200 hover:text-white transition duration-150 ease-in-out mb-2">
