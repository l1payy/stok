...
$classes = ($active ?? false)
            ? 'flex items-center px-4 py-3 text-sm font-medium text-white bg-accent rounded-lg transition duration-150 ease-in-out'
            : 'flex items-center px-4 py-3 text-sm font-medium text-blue-100 hover:text-white hover:bg-blue-800 rounded-lg transition duration-150 ease-in-out';
